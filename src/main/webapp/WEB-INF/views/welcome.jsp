...
<link href="${pageContext.request.contextPath}/css/easy-responsive-tabs.css" rel="stylesheet"/>
...
<script src="${pageContext.request.contextPath}/js/jcarousellite_1.0.1.min.js"></script>
...
<!-- //Twitter -->
 ...
 <div id="skip">
	<dl>
		...
		<dd><a href="#nav">go to the menu</a></dd>
		<dd><a href="#main">go to the main contents</a></dd>
	</dl>
</div>
<!-- //skip navigation -->
<div id="wrap">
	...
	<!--  S : header-->
	<header>
		<h1 class="logo"><a href="/En">HVCC Logo</a></h1>
        ...
        <section class="main_banner">
			<article class="main_view">
				<div class="flexslider">
					<ul class="slides">
						<li class="slide01"><a href="#"><img  src="${pageContext.request.contextPath}/images/main_banner4.jpg" alt="Create a Happy Nature. A New Wind is Blowing in Climate Control. We are your neighbor. We are a corporate citizen." />
						<div class="main_view_txt">
							<h2>Automotive Thermal Energy<br/>Management Solutions</h2>
							<p>We have a differentiated solution<br/>around system integration</p>
						</div>
						</a>						
						</li>
						<li class="slide02"><a href="#"><img   src="${pageContext.request.contextPath}/images/main_banner1.jpg" alt="Create a Happy Nature. A New Wind is Blowing in Climate Control. We are your neighbor. We are a corporate citizen." />
						<div class="main_view_txt">
							<h2>Deep R&D Expertise</h2>
							<p>Is one of the critical factors that allows <!-- 150721 삭제HVCC--> to deliver Innovative climate control solutions to vehicle manufactures.</p>
						</div>
						</a>
						
						</li>
						<li class="slide03"><a href="#"><img  src="${pageContext.request.contextPath}/images/main_banner3.jpg" alt="Create a Happy Nature. A New Wind is Blowing in Climate Control. We are your neighbor. We are a corporate citizen." />
						<div class="main_view_txt">
							<h2>Eco-Friendly Products</h2>
							<p>We seek to deliver eco-friendly solutions <br>that benefit customers and communities <br>around the world</p>
						</div>
						</a></li>
						<!-- 20140902 삭제
...
if (!isShow){
	...
	<!--  S : footer-->
	<footer>
		<div class="copyright">COPYRIGHT&copy;2018 Hanon Systems ALL RIGHTS RESERVED.</div>
		<nav>
			<a href="#">Sitemap</a>
			<a href="#">Privacy Policy</a>
			<a href="#">Contact Us</a>
			<a href="#" class="last copy_Ethics" >Ethics and Integrity</a>
		</nav>
		<!--<div class="sns">
